...
<title>Building Beautiful Websites with Bootstrap</title>
...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			<h2 class="mission-statement">
				We develop people<br> who develop software
			</h2>
			<div class="visible-sm visible-xs"></div>
			<img class="jumbotron-image" src="${pageContext.request.contextPath}/images/photo10.jpg">
		</div>
	</div>
	...
	<div align="center">
		<a href="bootstrap02.html" class="btn btn-warning btn-sm">Text
			Decoration</a> <a href="bootstrap03.html" class="btn btn-success btn-sm">Blockquotes</a>
	</div>
	...
	<div class="dropdown theme-dropdown clearfix">
		<a id="dropdownMenu1" href="#" role="button"
			class="sr-only dropdown-toggle" data-toggle="dropdown">Dropdown <span
			class="caret"></span></a>
	...
	<div id="carousel-example-generic" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="item active">
				<img data-src="${pageContext.request.contextPath}/images/photo01.jpg" alt="First slide">
			</div>
			<div class="item">
				<img data-src="${pageContext.request.contextPath}/images/photo02.jpg" alt="Second slide">
			</div>
			<div class="item">
				<img data-src="${pageContext.request.contextPath}/images/photo03.jpg" alt="Third slide">
			</div>
		</div>
